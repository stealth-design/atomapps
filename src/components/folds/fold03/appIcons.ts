...
export const ICON_LINKS: Partial<Record<string, { label: string; href: string }>> = {
  ...
  "icon-05": { label: "Find My Phone Launcher", href: "/apps/find-my-phone" },
  "icon-06": { label: "AI Chat Launcher: AI Assistant", href: "/apps/ai-chat" },
  "icon-07": { label: "2026 Calendar Launcher", href: "/apps/calendar" },
  "icon-08": { label: "Steppy Rewards Launcher — coming soon", href: "/apps/steppy" },
  ...
  "icon-15": { label: "White Noise Launcher — coming soon", href: "/apps/white-noise" },
